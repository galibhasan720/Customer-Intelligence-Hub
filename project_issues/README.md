...
Local implementation specs for SeatFlow Features **0–15**.  
Canonical stack: **Vercel (React)** · **Hugging Face Space (FastAPI Docker)** · **Supabase (Postgres + Auth)**.
...
| [03_backend-health-and-api-bootstrap.md](./03_backend-health-and-api-bootstrap.md) | 0 (health done) | #36 closed |
| [04_authentication-jwt-and-rbac.md](./04_authentication-jwt-and-rbac.md) | 2 | #41 |
| [05_profile-and-password-reset.md](./05_profile-and-password-reset.md) | 3–4 | #41 |
| [06_frontend-shell-routing-and-api-client.md](./06_frontend-shell-routing-and-api-client.md) | shell / audit | #39, #43 |
| [07_event-discovery-catalog-and-search.md](./07_event-discovery-catalog-and-search.md) | 5 | #44 |
| [08_organizer-event-crud-and-booking-windows.md](./08_organizer-event-crud-and-booking-windows.md) | 6 | #48 |
...
- `MVP/SeatFlow_Feature_Implementation_Order.md` (viva questions per feature)
- `MVP/Phase_order(features).md` (implementation phases)

## Obsolete

DynamoDB / Lambda / Mangum issue drafts were removed. Do not reopen that path for MVP.
